...
use App\Auth\{
	AuthModule, ForbiddenMiddleware
};
...
use Framework\Middleware\{
	CsrfMiddleware, DispatcherMiddleware, MethodMiddleware, NotFoundMiddleware, RendererRequestMiddleware, RouterMiddleware, TrailingSlashMiddleware
};
