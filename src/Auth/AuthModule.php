...
use App\Auth\Action\{
	LoginAction, LoginAttemptAction, LogoutAction, PasswordForgetAction, PasswordResetAction
};
...
class AuthModule extends Module
{
	...
	public function __construct(ContainerInterface $container, Router $router, RendererInterface $renderer)
	{
		...
		$router->any('/forget-password/reset/{id:\d+}/{token}', PasswordResetAction::class,
