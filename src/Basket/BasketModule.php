...
use App\Basket\Action\{
	BasketAction, OrderInvoiceAction, OrderListingAction, OrderProcessAction, OrderSummaryAction
};
...
class BasketModule extends Module
{
	...
	public function __construct(
		...
		$router->get('/my-orders/{id:\d+}', [LoggedInMiddleware::class, OrderInvoiceAction::class],
